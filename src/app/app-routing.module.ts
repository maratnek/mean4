...
import {StockTableInfoComponent} from './components/stock/stock-table/stock-table-info/stock-table-info.component';
...
const routes: Routes = [
  ...
  {path: 'stock/:id', component: StockTableInfoComponent, canActivate:[StockGuard]},
